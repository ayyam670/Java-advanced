...
//		System.out.println("basic...");
	...
	public String ex01(@ModelAttribute("sample") SampleDTO sample, RedirectAttributes ra) {
		...
		//return "redirect:success";  // 절대경로 : http://localhost:81/success
									  // redirect 뒤에는 매핑 url을 적어줌  redirect는 status 302
									  // forward 뒤에는 페이지명
		//return "redirect:success";  // 상대경로 : httpL//localhost:81/sample/success
	...
	@GetMapping("/ex02")   // ex02?name=aaa&age=20     int는 null을 못받아서 null값을 받으려면 Integer 사용해야함
